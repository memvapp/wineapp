...
public class nfcdemo extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(parametros !=null) {
		    ...
		    codbar =   parametros.getString("codigoBar");
		    //Toast.makeText(this, "codigo de barras:"+codbar, Toast.LENGTH_LONG).show();
			}
		
	
		if (!mNfcAdapter.isEnabled()) {
			mTextView.setText("NFC esta desabilitado, active NFC.");
		} else {
		...
		protected void onPostExecute(String result) {
			if (result != null) {
				//mTextView.setText("Contenido Leido: " + result);
				 Intent i = new Intent(nfcdemo.this, enviobdd.class);
				 i.putExtra("codigonfc",result);
